...
<div class="panel panel-default">
	<div class="panel-body">
		...
		<div class="pull-right">
			<?php
			$strLink = "https://$_SERVER[HTTP_HOST]$_SERVER[REQUEST_URI]";
			?>
			...
			<a rel="nofollow" href="https://www.twitter.com/intent/tweet?text=<?php echo urlencode(strip_tags(stripslashes($listings->listing[$id]->title)));?>&url=<?php echo $strLink;?>" target="_blank"><img src="images/twitter.gif" width="18" height="18" class="r-margin-7" alt=""/></a>
			<a rel="nofollow" href="https://www.facebook.com/sharer.php?u=<?php echo $strLink;?>" target="_blank"><img src="images/facebook.gif" width="18" height="18" alt="" class="r-margin-7"/></a>
		</div>
